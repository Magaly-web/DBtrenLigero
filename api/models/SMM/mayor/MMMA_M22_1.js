...
var mmmaM22_1Schema = Schema({//esquema de la estructura que va a tener el formulario
    ...
    //1. MANTENIMIENTO DE ACOPLADORES
...
module.exports = mongoose.model('mmmaM22_1', mmmaM22_1Schema);