...
var mmmaM50Schema = Schema({//esquema de la estructura que va a tener el formulario
    ...
    pruebaHermeticidad: Boolean,
    observacionesPh: String,
...
module.exports = mongoose.model('mmmaM50', mmmaM50Schema);