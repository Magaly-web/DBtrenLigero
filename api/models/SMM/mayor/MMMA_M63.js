...
var mmmaM63Schema = Schema({//esquema de la estructura que va a tener el formulario
    ...
    verificacionHermeticidad: Boolean,
    observacionesVh: String,

    verificacionAccionamiento: Boolean,
    observacionesVa: String,

    pruebaElectronica: Boolean,
...
module.exports = mongoose.model('mmmaM63', mmmaM63Schema);